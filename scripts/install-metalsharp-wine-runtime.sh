...
PART01_SHA256="e3ff07bafe27fbf0f4fd7f761e962e7b3203e7e730c82d5d3e26fd5062bb0568"
...
write_metalsharp_layout() {
  ...
  ln -s ../build-ec/dxmt-v0.80 "$lib/dxmt-vkd3d"
  ln -s ../build-ec/dxmt-v0.80 "$lib/dxmt_vkd3d"
