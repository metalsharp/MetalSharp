...
- The shader diagnostic probe proves malformed DXIL is rejected with a
  ...
  to match `math_bits`, `math_intrinsics`, and all 56 semantic lanes, including
  ...
  four-component case. Profile `phase5-long-unary` passes 53/53
  ...
  all/any reduction, componentwise negation/absolute-value, and
  divide/shift/remainder readbacks (`120.0f`, `72.0f`, `40`, `80`, `156.0f`,
  `1/1`, `44.0f`, `20/88/8`, and `816.0f` respectively). The compact
