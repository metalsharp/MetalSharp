...
- [D3D12 Pipeline Map](architecture/m12-pipeline-map.md) - current M12 vkd3d-proton/Vulkan/MoltenVK path.
...
- [DXMT and Vulkan Architecture](architecture/dxmt-vulkan-architecture.md) - DXMT M9-M11 and M12 Vulkan ownership boundaries.
