...
Downloads MetalSharp-owned runtime assets from the GitHub release: Wine, graphics DLLs (DXMT for M9/M10/M11, vkd3d-proton + DXVK + VKMT MoltenVK for the VKD3D route, plus the DXMT VKD3D rollback lane), Steam setup files, Mono/FNA support files, Goldberg assets, and other bundled runtime material.
