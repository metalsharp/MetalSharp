...
const phraseKeys: Record<string, string> = {
  ...
  "PCSX2 Setup": "ui.source.setup",
  "Import BIOS": "ui.source.importBios",
  "Download Firmware": "ui.source.downloadFirmware",
  "Find Games": "ui.source.findGames",
  "Add Games": "ui.source.addGames",
  "Accepts a .bin BIOS file": "ui.source.importBios",
  "Open archive.org": "ui.source.openEnvironment",
  "Controllers & renderer": "ui.source.setup",
  "Open PCSX2": "ui.sharp.open",
  "Open RPCS3": "ui.sharp.open",
